...
def menu_enseres(VENTANA, estado):
    ...
    while True:
        ...
        dibujar_titulo(VENTANA, "ENSERES", y=40)

        panel = pygame.Rect(80, 120, 740, 420)
        dibujar_panel(VENTANA, panel)

        dibujar_texto(VENTANA, "Listado de enseres (placeholder):", 110, 160)
        dibujar_texto(VENTANA, "• Cruz de guía", 130, 200)
        dibujar_texto(VENTANA, "• Faroles", 130, 230)
        dibujar_texto(VENTANA, "• Bocinas", 130, 260)
        dibujar_texto(VENTANA, "• Estandarte", 130, 290)
